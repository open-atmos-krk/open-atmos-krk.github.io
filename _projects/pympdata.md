...
### Selected papers on the MPDATA algorithm (features implemented in PyMPDATA)
 ...
 - [Smolarkiewicz 2006 (<cite>Int. J. Numer. Methods Fluids 50</cite>)](https://doi.org/10.1002/fld.1071): "<em>Multidimensional positive definite advection transport algorithm: an overview</em>"
 - [Margolin & Shashkov 2006 (<cite>Int. J. Numer. Methods Fluids 50</cite>)](https://doi.org/10.1002/fld.1070): "<em>MPDATA: gauge transformations, limiters and monotonicity†</em>"
...
### Papers on or using PyMPDATA
 ...
 - [Olesik et al. 2022 (GMD 15)](https://doi.org/10.5194/gmd-15-3879-2022): "<em>On numerical broadening of particle-size spectra: a condensational growth study using PyMPDATA 1.0</em>"
...
### 🎓 Student project opportunities
 ...
 - stacked [shallow-water](https://en.wikipedia.org/wiki/Shallow_water_equations) system (isopycnic ocean model)
 - introduction of a backend layer and a new [<cite>JAX</cite>](https://jax.dev/) backend   
