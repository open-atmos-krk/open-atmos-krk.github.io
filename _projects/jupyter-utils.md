...
<ul>
  <li>Engineer a <a href="https://docs.pytest.org/en/stable/">pytest</a> plugin based on the <code>notebook_vars</code> utility function</li>
  <li>Extend support to other plot-generating packages beyond matplotlib</li>
  <li>Develop an automated testing solution validating the generated svg/pdf/gif files (as well as correctness of pdfs generated by nbconvert)</li>
</ul>
