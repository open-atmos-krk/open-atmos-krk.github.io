...
<p>PySDM v1 constituted the <a href="https://www.ap.uj.edu.pl/diplomas/141204/">MSc thesis of Piotr Bartman</a> who had
   developed PySDM API, adaptive numerical solvers and package architecture architecture.
  ...
  Subsequent developements had been largely spearheaded by <a href="https://github.com/ekdejong">Emily de Jong</a> and 
   <a href="https://claresinger.github.io/">Clare Singer</a> from Caltech CliMA team, and
  ...
  The original collisional breakup scheme (maintaining the key constant-state-vector size trait of SDM)
   ...
   (with section 3 based on <a href="https://www.ap.uj.edu.pl/diplomas/166879/">MSc thesis of Oleksii Bulenok</a>).
  The original adaptive time-stepping scheme for SDM introduced in PySDM v1 has been the topic of further research
   by <a href="https://emmaware.weebly.com/">Emma Ware</a> which was summarised in 
